    ...
    <main id='main' class="site-main"  role="main">          
        <div style="width : 70%; margin: 0 auto;">
            <form id="DoctorApointment_user_input">
                ...
                <?php wp_nonce_field( basename(__FILE__),"doctor-appoinment-request" );?>
                ...
                <br>
                <textarea name="DoctorAppointment_message" id="DoctorAppointment_message" cols="30" rows="10" required></textarea>
                <br>
